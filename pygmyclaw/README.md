...
**PygmyClaw** is a compact Py based openclaw clone that features a persistent task queue (Redis or file‑based) and a modular tool system implemented in a separate Python script.

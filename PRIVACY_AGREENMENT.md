...
edTV and related techonology (webxos.netlify.app/mirror webcam use and related tech etc) is a free open sourced experimental browser-based augmented reality (AR) tool developed as part of the webXOS software project in this repo. It is provided for **testing purposes and non-commercial research only**, hosted at [webxos.netlify.app/edTV](https://webxos.netlify.app/edTV.html) and available under the open-source [MIT License] on GitHub at [github.com/webxos](https://github.com/webxos). 

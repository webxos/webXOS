...
STACK_AUTH_CLIENT_SECRET = os.getenv('STACK_AUTH_CLIENT_SECRET', 'ssk_jg4mmhab0d0ga2krj1sskadmnkaagcxy7nxwbaeagkbjg')
JWT_SECRET_KEY = os.getenv('JWT_SECRET_KEY', 'your_jwt_secret_key')
NETLIFY_SITE_ID = os.getenv('NETLIFY_SITE_ID')
NETLIFY_AUTH_TOKEN = os.getenv('NETLIFY_AUTH_TOKEN')
REPO_PATH = os.getenv('REPO_PATH', './repo')
ALLOWED_ORIGINS = ["https://webxos.netlify.app", "http://localhost:3000"]

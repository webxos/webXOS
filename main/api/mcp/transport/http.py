...
from ...mcp_schemas import MCPRequest, MCPResponse

router = APIRouter()
mcp_server = MCPServer()

async def handle_http_request(request: MCPRequest) -> MCPResponse:
    try:
